...
class Main extends PluginBase implements Listener {
	...
	public function onCommand(Commandsender $sender, Command $command, string $label, array $args) : bool{
        ...
        $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
          ...
          if($sender->hasPermission("profile.command")){
...

	{
	    ...
	    $titlerewardsconfig = $config->get("title-profile");

	    $titlerewards = str_replace(["&", "+n",], ["§", "\n"], $titlerewardsconfig);

	    $this->menu->readonly();

	    $this->menu->setListener([$this, "profilemenu"]);
	    ...
	    $in14 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig14);	    
	    ...
	    $in16 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig16);	    
	    ...
	    $in24 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig24);
	    ...
	    $in26 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig26);
	    ...
	    $in27 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig27);
	    ...
	    $in28 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig28);
	    ...
	    $in29 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig29);
	    ...
	    $in30 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig30);
	    ...
	    $in31 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig31);
	    ...
	    $in32 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig32);
	    ...
	    $in33 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig33);
	    ...
	    $in34 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig34);
	    ...
	    $in35 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig35);
	    ...
	    $in36 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig36);
	    ...
	    $in37 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig37);
	    ...
	    $in38 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig38);
	    ...
	    $in39 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig39);
	    ...
	    $in40 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig40);
	    ...
	    $in41 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig41);
	    ...
	    $in42 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig42);
	    ...
	    $in43 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig43);
	    ...
	    $in44 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig44);
	    ...
	    $in45 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig45);
	    ...
	    $in46 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig46);
	    ...
	    $in47 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig47);
	    ...
	    $in48 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig48);
	    ...
	    $in49 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig49);
	    ...
	    $in50 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig50);
	    ...
	    $in51 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig51);
	    ...
	    $in52 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig52);
	    ...
	    $in53 = str_replace(["&", "+n", "%player_name%", "%player_ping%", "%player_address%", "%player_client_id%", "%player_direction%", "%player_displayname%", "%player_hunger%", "%player_x%", "%player_y%", "%player_z%", "%player_hunger_point%", "%player_gamemode%", "%player_health_point%", "%player_location%", "%player_hunger_point_max%", "%player_health_point_max%", "%player_scale%", "%server_online%", "%server_max_players%", "%item_id%", "%item_meta%", "%item_count%", "%item_name%", "%server_load%", "%server_tps%", "%level_name%", "%level_folder_name%", "%level_player_count%", "%player_balance%", "%player_rank%", "%player_prefix%", "%player_suffix%"], ["§", "\n", $sender->getName(), $sender->getPing(), $sender->getAddress(), $sender->getClientId(), $sender->getDirection(), $sender->getDisplayName(), $sender->getExhaustion(), $sender->getFloorX(), $sender->getFloorY(), $sender->getFloorZ(), $sender->getFood(), $sender->getGamemode(), $sender->getHealth(), $sender->getLocation(), $sender->getMaxFood(), $sender->getMaxHealth(), $sender->getScale(), count($sender->getServer()->getOnlinePlayers()), $sender->getServer()->getMaxPlayers(), $sender->getInventory()->getItemInHand()->getId(), $sender->getInventory()->getItemInHand()->getDamage(), $sender->getInventory()->getItemInHand()->getCount(), $sender->getInventory()->getItemInHand()->getName(), $sender->getServer()->getTickUsage(), $sender->getServer()->getTicksPerSecond(), $sender->getLevel()->getName(), $sender->getLevel()->getFolderName(), count($sender->getLevel()->getPlayers()), $this->economyAPI->myMoney($sender), $this->getPlayerRank($sender), $this->getPrefix($sender), $this->getSuffix($sender)], $inconfig53);
	...
	public function profilemenu(Player $sender, Item $item)
	...
	/**
		...
		public function getPlayerRank(Player $sender): string{

			$group = $this->purePerms->getUserDataMgr()->getData($sender)['group'];
		...
		public function getPrefix(Player $sender, $levelName = null): string{

			$purePerms = $this->purePerms;

			$prefix = $purePerms->getUserDataMgr()->getNode($sender, "prefix");
			...
			if($levelName === null){
				...
				$worldData = $purePerms->getUserDataMgr()->getWorldData($sender, $levelName);
		...
		public function getSuffix(Player $sender, $levelName = null): string{

			$purePerms = $this->purePerms;

			$suffix = $purePerms->getUserDataMgr()->getNode($sender, "suffix");
